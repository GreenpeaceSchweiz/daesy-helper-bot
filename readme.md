...
**Set Up**
0. Install and set up *Task* (`winget install Task.Task`) and *Google Cloud CLI*
1. Clone the repository
2. Run `uv sync`
3. Create `.env` file based on `.env.example` and complete it with the secrets for your Slack App, Asana Project, etc.
...
**Running locally**
4. Start daesy_helper: `task dev:local`
5. Start `ngrok` in a separate terminal: `task:dev:tunnel`.
...
3. Compile and deploy: `task update:all`
